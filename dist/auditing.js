import { GENERAL_STOPWORDS } from './presets.js';
...
export class RequirementAuditor {
    ...
    inEdges;
    domainConfig;
    constructor(knowledgeGraph, domainConfig) {
    ...
    getDescendantRequirements(secNodeId, visited) {
        const requirements = [];
        const sections = [];
    ...
    queryContext(query) {
        ...
        const linkedTerms = [];
        const conflicts = [];
        const visited = new Set(targetNodes.map(n => n.id));
